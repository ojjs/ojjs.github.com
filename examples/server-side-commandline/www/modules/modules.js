...
// Define modules M
M['/node_modules'] = {"oj-twitter-button":"src/oj.TwitterButton.js","underscore":"underscore.js"};

// Define files F
F['/modules/modules.oj'] = (function(module,exports){(function(require,process,global,__dirname,__filename){
(function(){with(oj.sandbox){require('oj-twitter-button')
require('underscore')
}}).call(this);})(RR('/modules/modules.oj'),P,G,'/modules','modules.oj');});
...
require = RR('/modules/modules')
oj = require('oj')
oj.load('/modules')}).call(this);