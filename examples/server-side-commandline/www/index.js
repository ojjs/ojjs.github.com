// Generated with oj v0.2.2
;(function(){var M = {}, F = {}, R = {}, P, G, RR;

// Define modules M
M['/node_modules'] = {"underscore":"underscore.js","backbone":"backbone.js","oj-twitter-button":"src/oj.TwitterButton.js"};

// Define files F
F['/index.oj'] = (function(module,exports){(function(require,process,global,__dirname,__filename){
(function(){with(oj.sandbox){// OJ Example: Server-side Commandline Tool
...
}}).call(this);})(RR('/index.oj'),P,G,'/','index.oj');});
...
})(RR('/node_modules/backbone/backbone.js'),P,G,'/node_modules/backbone','backbone.js');});
...
})(this);})(RR('/node_modules/oj-twitter-button/src/oj.TwitterButton.js'),P,G,'/node_modules/oj-twitter-button/src','oj.TwitterButton.js');});

F['/_twitterLink.oj'] = (function(module,exports){(function(require,process,global,__dirname,__filename){
(function(){with(oj.sandbox){
// Create a _twitterUserLink partial
module.exports = function(user){
  // Generate an anchor tag with text and href
  a('Follow ' + user.get('name') + ' on Twitter', {href:'http://twitter.com/' + user.get('twitter')});
};}}).call(this);})(RR('/_twitterLink.oj'),P,G,'/','_twitterLink.oj');});
